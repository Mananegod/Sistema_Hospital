...
- Prevención de FOUC (ancho definido por variable CSS desde el
...
<head>).
    ...
    <div class="relative" x-data="{ ready: false }" x-init="setTimeout(() => ready = true, 50)">
        ...
        <div x-show="$store.sidebar.mobileOpen" x-transition:enter="transition ease-out duration-300"
            x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100"
            x-transition:leave="transition ease-in duration-200" x-transition:leave-start="opacity-100"
            x-transition:leave-end="opacity-0" @click="$store.sidebar.toggleMobile()"
            class="fixed inset-0 bg-slate-950/80 z-40 lg:hidden backdrop-blur-sm" x-cloak>
        </div>
        ...
        <aside :class="{
            ...
            <div class="relative flex items-center h-20 border-b border-slate-800 shrink-0" :class="{
                ...
                <div class="flex items-center gap-3 overflow-hidden">
                    <div
                        class="bg-blue-600 p-2.5 rounded-xl shadow-lg shadow-blue-500/20 shrink-0 flex items-center justify-center">
                        <i class="fa-solid fa-hospital text-white text-lg"></i>
                    </div>
                    <span x-show="$store.sidebar.open" x-transition:enter="transition delay-100 duration-200"
                ...
                <div>
                    <div class="h-6 flex items-center mb-2" :class="$store.sidebar.open ? 'px-6' : 'justify-center'">
                        <p x-show="$store.sidebar.open"
                            class="text-[10px] font-bold uppercase tracking-widest text-slate-500 truncate transition-opacity duration-200">
                            General
                        </p>
                        <div x-show="!$store.sidebar.open"
                            class="w-6 h-px bg-slate-800 transition-opacity duration-200"></div>
                    </div>
                    <ul class="space-y-1">
                        <li>
                            <a href="{{ route('home') }}"
                        ...
                        <li>
                            <a href="{{ route('estadisticas.index') }}"
                               ...
                               'transition-all duration-200': ready
                                ...
                                <div class="w-6 flex justify-center shrink-0">
                                    <i
                                        class="fa-solid fa-chart-pie text-lg group-hover:scale-110 transition-transform"></i>
                                </div>
                        ...
                        <li>
                            <a href="{{ route('pacientes.index') }}"
                               ...
                               'transition-all duration-200': ready
                                ...
                                <div class="w-6 flex justify-center shrink-0">
                                    <i
                                        class="fa-solid fa-user-injured text-lg group-hover:scale-110 transition-transform"></i>
                                </div>
                        ...
                        <li>
                            <a href="{{ route('epidemiologia.index') }}"
                               ...
                               'transition-all duration-200': ready
                                ...
                                <div class="w-6 flex justify-center shrink-0">
                                    <i
                                        class="fa-solid fa-shield-virus text-lg group-hover:scale-110 transition-transform"></i>
                                </div>
                                <span x-show="$store.sidebar.open"
                                    class="text-sm whitespace-nowrap">Epidemiología</span>
                            </a>
                        </li>
                    </ul>
                </div>
                        ...
                        <li>
                            <a href="{{ route('almacen.index') }}"
                               ...
                               'transition-all duration-200': ready
                                ...
                                <div class="w-6 flex justify-center shrink-0">
                                    <i
                                        class="fa-solid fa-box-archive text-lg group-hover:scale-110 transition-transform"></i>
                                </div>
                        ...
                        <li>
                            <a href="{{ route('retiros.index') }}"
                               ...
                               'transition-all duration-200': ready
                                ...
                                <div class="w-6 flex justify-center shrink-0">
                                    <i
                                        class="fa-solid fa-hand-holding-medical text-lg group-hover:scale-110 transition-transform"></i>
                                </div>
                        ...
                        <li>
                            <a href="{{ route('personal.bitacora') }}"
                               ...
                               'transition-all duration-200': ready
                                ...
                                <div class="w-6 flex justify-center shrink-0">
                                    <i
                                        class="fa-solid fa-clock-rotate-left text-lg group-hover:scale-110 transition-transform"></i>
                                </div>
                                <span x-show="$store.sidebar.open" class="text-sm whitespace-nowrap">Bitácora del
                                    Sistema</span>
                            </a>
                        </li>
                    </ul>
            ...
            <div class="p-4 border-t border-slate-800 bg-slate-950/30 flex flex-col gap-2 shrink-0">
             ...
             'transition-all duration-300': ready
                    ...
                    <div
                        class="h-10 w-10 rounded-xl bg-blue-600/10 border border-blue-500/20 flex items-center justify-center font-black text-blue-400 tracking-tighter shrink-0 shadow-inner">
                        DC
                    </div>
                ...
                <form action="{{ route('logout') }}" method="POST">
                    ...
                    'transition-all duration-200': ready
                        ...
                        <div class="w-6 flex justify-center shrink-0">
                            <i
                                class="fa-solid fa-arrow-right-from-bracket text-base group-hover:-translate-x-0.5 group-hover:scale-110 transition-transform"></i>
                        </div>
                        <span class="font-semibold text-xs whitespace-nowrap" x-show="$store.sidebar.open"
