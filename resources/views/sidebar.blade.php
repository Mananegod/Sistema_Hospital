...
<aside class="w-72 bg-slate-900 text-white flex-shrink-0 sticky top-0 h-screen flex flex-col shadow-2xl">
    <div class="p-8">
        ...
        <nav class="space-y-3">
            ...
            <a href="{{ route('personal.index') }}"
                ...
                <span class="font-semibold tracking-wide">Personal</span>
            </a>
            ...
            <a href="{{ route('personal.bitacora') }}"
                ...
                <span class="font-semibold tracking-wide">Bitácora</span>
            </a>
        </nav>
    </div>
    ...
    <div class="mt-auto p-8 border-t border-slate-800 bg-slate-900/50">
        ...
        <div class="flex items-center gap-3 mb-6 ">
            ...
            <div
                class="w-10 h-10 rounded-full bg-blue-500/50 border border-blue-500/40 flex items-center justify-center text-blue-400 font-bold text-xs">
                DC</div>
            <div>
                <p class="text-sm font-bold text-slate-200">David Camacho</p>
                <p class="text-xs text-slate-400">Administrador</p>
            </div>
        </div>

        <a href="{{ url('/') }}"
            class="flex items-center gap-3 px-4 py-3 rounded-xl text-red-400 hover:bg-red-500/10 bg-red-300/10 transition-all">
