...
@section('content')
    ...
    <div class="max-w-7xl mx-auto" x-data="{
        ...
        <div class="mb-8 flex justify-between items-end">
            ...
            <button @click="$store.modal.open('modalImportar')"
            ...
            <div class="lg:col-span-1 space-y-6">
                <div class="bg-white p-6 rounded-3xl shadow-sm border border-slate-100">
                    ...
                    <form action="{{ route('stock.entrada') }}" method="POST" class="space-y-4">
                        ...
                        <button type="submit" :disabled="$store.loading.active"
                    ...
                    <div class="p-6 border-b border-slate-100 flex justify-between items-center bg-slate-50/50">
                        ...
                        <form action="{{ route('almacen.index') }}" method="GET" class="flex gap-2">
                            <select name="area_id" onchange="this.form.submit()"
                                class="text-sm border-slate-200 rounded-lg focus:ring-blue-500">
        ...
        <form action="{{ route('inventario.import') }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="space-y-4">
                ...
                <input type="file" name="archivo" accept=".xlsx, .xls, .csv" required
                    class="w-full text-sm text-slate-500 file:mr-4 file:py-2 file:px-4 file:rounded-xl file:border-0 file:bg-blue-50 file:text-blue-700">
            ...
            <div class="flex gap-3 mt-8">
                ...
                <button type="submit"
                    class="flex-1 bg-blue-600 text-white font-bold py-3 rounded-xl hover:bg-blue-700 shadow-lg shadow-blue-500/30 transition">
                    Comenzar Carga
                </button>
            </div>
        </form>
