...
@section('content')
{{-- Eliminamos márgenes laterales en móvil para que ocupe todo el ancho de la pantalla --}}
<div class="max-w-7xl mx-auto px-0 sm:px-4">
    {{-- Encabezado responsivo con padding adaptativo en los lados --}}
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4 mb-6 sm:mb-10 px-4 sm:px-0">
        <div>
        ...
        <div class="w-full overflow-x-auto">
            ...
            <table class="w-full text-left min-w-[750px]">
                <thead class="bg-slate-900 text-white text-[8px] sm:text-[10px] font-bold uppercase tracking-widest">
                    <tr>
                        <th class="px-4 sm:px-6 py-3 sm:py-4">Módulo</th>
                        <th class="px-4 sm:px-6 py-3 sm:py-4">Acción</th>
                        <th class="px-4 sm:px-6 py-3 sm:py-4">Descripción del Evento</th>
                        <th class="px-4 sm:px-6 py-3 sm:py-4 text-right">Fecha y Hora</th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-slate-100">
                    ...
                    <tr class="hover:bg-blue-50/30 transition-colors">
                        ...
                        <td class="px-4 sm:px-6 py-4 sm:py-5 font-bold text-xs sm:text-sm">
                        ...
                        <td class="px-4 sm:px-6 py-4 sm:py-5 text-slate-600 text-xs sm:text-sm font-medium leading-relaxed">
                            {{ $reg->descripcion }}
                            <p class="text-[8px] sm:text-[10px] text-slate-400 mt-1 uppercase tracking-tighter">Realizado por: {{ $reg->usuario }}</p>
                        </td>
                        <td class="px-4 sm:px-6 py-4 sm:py-5 text-right whitespace-nowrap">
                    ...
                    @empty
                    <tr>
                        <td colspan="4" class="px-4 sm:px-6 py-12 sm:py-20 text-center">
